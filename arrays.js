...
var colores = [
  ...
  "Naranja",
  "Verde",
  ["Verde Pastel", "Amarillo Pastel", "Rosa Pastel"],
];
...
console.log(
  "El elemento en la posicion 2 de mis asignaturas es: ",
  asignaturas[2]
);
...
var listaDeFrutitasYVerduritas = [
  "manzanas",
  "mangos",
  "toronjas",
  "platanos",
...
var listaDeComprasDeLaQuincena = listaDeGolosinas.concat(
  listaDeFrutitasYVerduritas
);
